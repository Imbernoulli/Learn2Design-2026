...
See [Storage & Checkpointing](Storage-and-Checkpointing.md) for the full storage architecture and the individual component APIs, and [Problems](Problems.md) for the `ProblemSpec` container and the reconstructive contract.
